           ...
           <h3 className="heading">contact us</h3>
            ...
            <div className="row contact-content">
                ...
                <div  className="col-lg-6 col-md-12 contact-info">
                    ...
                    <p><i class="fas fa-map-marker-alt" /><span className="ms-1">184 Main Rd E, St Albans Victoria 3021, Australia</span></p>
                    <p><i class="fas fa-phone" /><span className="ms-1">1800-123-222 / 1900-1570-230</span></p>
                    <p><i class="fas fa-envelope" /><span className="ms-1">contact@company.com</span></p>
                    <p><i class="far fa-clock" /><span className="ms-1">Everyday 9:00-17:00</span></p>
                </div>
            </div>
        </div>
       </div>
